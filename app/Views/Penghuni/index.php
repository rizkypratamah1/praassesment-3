                ...
                <tbody>
                    ...
                    <?php foreach ($penghuni as $row) : ?>
                        <tr>
                            ...
                            <td><?= $row['foto'] ?></td>
                            <td>
                                <button type="button" data-toggle="modal" data-target="#modalUbah" class="btn btn-sm btn-warning" id="btn-edit" data-id_penghuni="<?= $row['id_penghuni']; ?>" data-no_ktp="<?= $row['no_ktp']; ?>" data-unit="<?= $row['unit']; ?>" data-foto="<?= $row['foto']; ?>"><i class="fa fa-edit"></i></button>
            ...
            <div class="modal-body">
                <form action="<?= base_url('penghuni/ubah'); ?>" method="post">
                    <div class="form-group mb-0">
                        ...
                        <input type="hidden" name="id_penghuni" id="id_penghuni" class="form-control" placeholder="ID penghuni" value=<?= $row['id_penghuni'] ?>>
                    </div>
                    <div class="form-group mb-0">
                        <label for="Nama"></label>
